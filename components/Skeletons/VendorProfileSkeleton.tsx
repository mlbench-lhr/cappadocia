  ...
  return (
    <div className="animate-pulse w-full flex flex-col gap-4 pb-8">
      ...
      <div className="w-full h-[320px] bg-gray-200 rounded-xl relative">
        <div className="w-[90px] h-[90px] md:w-[180px] md:h-[180px] rounded-full bg-gray-300 absolute left-4 sm:left-8 lg:left-14 bottom-0 ring-2 ring-white" />
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start -mt-10 sm:-mt-8 md:mt-3 lg:-mt-8 gap-3">
        ...
        <div className="w-full md:w-[160px] h-10 bg-gray-300 rounded-lg" />
      </div>
      ...
      <div className="w-full space-y-3">
        ...
        <div className="w-40 h-10 bg-gray-300 rounded-lg mx-auto" />
      </div>
    </div>
  );
}
