...
import { ChevronLeft, Clock, CreditCard, Timer, Users, MapPin, Navigation, Phone, Mail } from 'lucide-react';
...
const BookingInformation: React.FC = () => {
    return (
        <div className="">
            ...
            <h3 className="text-xl font-bold mb-4">Cappadocia balloons flying at sunrise</h3>

            <div className="space-y-3 text-gray-600">
                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/clock.svg" alt='phone' width={20} height={20} />
                    <span>Date & Time: Jun 20, 2024 | 03:00 PM</span>
                </div>

                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/booking.svg" alt='phone' width={20} height={20} />
                    <span>Booking ID: #CT-2025-001242</span>
                </div>

                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/duration.svg" alt='phone' width={20} height={20} />
                    <span>Duration: 60 Minutes</span>
                </div>

                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/price.svg" alt='phone' width={20} height={20} />
                    <span>Price Per Person: €120</span>
                </div>

                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/payment.svg" alt='phone' width={20} height={20} />
                    <span>Payment Method: Not Completed</span>
                </div>

                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/people.svg" alt='phone' width={20} height={20} />
                    <span>Participants: 2 Adults</span>
                </div>

                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/total.svg" alt='phone' width={20} height={20} />
                    <span>Total Price: €350</span>
                </div>

                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/location.svg" alt='phone' width={20} height={20} />
                    <span>Location: Cappadocia,Turkey</span>
                </div>

                <div className="flex items-center gap-3">
                    <Image src="/admin-images/reservation/meeting.svg" alt='phone' width={20} height={20} />
                ...
                <div className="flex items-center justify-between mb-4 ">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-center gap-1 text-pink-600 bg-[#EB00891A] px-2 py-1 rounded-full">
                            <Image src="/admin-images/reservation/map.svg" alt='phone' width={20} height={20} />
        ...
        <div className="">
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-600">
                    <Image src="/admin-images/reservation/phone.svg" alt='phone' width={20} height={20} />
                    <span className='text-sm'>+90 384 123 4567</span>
                </div>

                <div className="flex items-center gap-3 text-gray-600 text-sm">
                    <Image src="/admin-images/reservation/mail.svg" alt='phone' width={20} height={20} />
        ...
        <div className="bg-white p-6 rounded-lg border">
            ...
            <div className="flex gap-4">
                <div className="w-32 h-32 ">
                    <Image src="/admin-images/reservation/QR.png" alt='QR' width={20} height={20} className='w-full h-full' />
                </div>
