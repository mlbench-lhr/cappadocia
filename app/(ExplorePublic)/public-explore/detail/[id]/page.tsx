...
import { AlternativeOptions } from "@/app/(Protected)/explore/detail/[id]/AlternativeOptions";
import { AvailabilityFilter } from "@/app/(Protected)/explore/detail/[id]/AvailabilityFilter";
...
export default function PublicExploreDetailPage() {
