    ...
    <div className="w-full flex flex-col justify-start items-start gap-[20px]">
      ...
      <DayPicker
        ...
        classNames={{
          ...
          today: cn(
            "bg-[#5AD2A6] text-accent-foreground rounded-md data-[selected=true]:rounded-none",
            defaultClassNames.today
          ),
          outside: cn(
            "text-muted-foreground aria-selected:text-[#5AD2A6]",
