...
export default function ImageSlider() {
  ...
  return (
    <div className="h-[300px] md:h-[380px] flex flex-col justify-center items-start gap-4 relative w-full p-7 overflow-hidden rounded-2xl">
      {/* Slider Images */}
      {slides.map((slide, index) => (
        <Image
          ...
          width={0}
          height={360}
          className={`w-full h-[300px] md:h-[380px] absolute top-0 left-0 object-cover object-bottom transition-opacity duration-700 ${
