  ...
  return (
    <div className="w-full h-fit pt-24">
      <div className="w-full flex flex-col items-center justify-center h-fit px-[20px] xl:px-[150px] pt-[20px] lg:pt-[35px] pb-[40px] lg:pb-[90px] bg-[white] gap-14">
        <div className="w-full flex justify-start items-center gap-15">
          ...
          <div className="w-[calc(100%-530px)] flex flex-col justify-start items-start gap-12">
            <h1 className="font-semibold text-[37px]">About Us </h1>
            <p className="w-[555px] text-[22px] leading-tight">
