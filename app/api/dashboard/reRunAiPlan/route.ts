...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: `
Generate **exactly 10 milestones** in valid JSON format for a student based on this info:
...
- All 10 milestones must logically match the user info (e.g., major, dream school, extracurriculars, GPA, tier).
- Make descriptions detailed but concise.
      `,
    });
